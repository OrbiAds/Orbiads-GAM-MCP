...
description: Use for GAM inventory and targeting — ad units, placements, custom targeting keys/values, audience segments, and inventory blueprints — through OrbiAds MCP actions or their orbiads CLI equivalents. Examples: "list my ad units", "create a placement", "add a targeting key". Enforces read-first, preview-before-write, and billing-guard rules.
version: 1.0.0
author: OrbiAds
license: MIT
metadata:
  group: inventory
  tags: [orbiads, gam, adops, inventory, targeting]
...
# OrbiAds GAM — Inventory & Targeting Management
